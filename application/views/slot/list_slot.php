      ...
      <div class="container">
        ...
        <div class="row mt-4">
          <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            <div class="d-flex justify-content-center">
              <img src="<?=base_url('./assets/img/core-img/SLOT-logo.png');?>" class="img-fluid" alt="">
            </div>
          </div>
        </div>
            ...
            <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100 p-0" style="border-radius: 30px;">
                            <img src="<?=base_url('./assets/img/client/pg.png');?>" alt="game6" style="width: 247px;height: 94px;" align="center">
                        </button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100 p-0" style="border-radius: 30px;">
                            <img src="<?=base_url('./assets/img/client/live22.png');?>" alt="game1" style="width: 206px;height: 84px;" align="center">
                        </button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100" style="border-radius: 30px;">
                            <img src="<?=base_url('./assets/img/client/logospad.png');?>" alt="game1" style="width: 100%;" align="center">
                        </button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100" style="border-radius: 30px;">
                            <img src="<?=base_url('./assets/img/client/gamatron1.png');?>" alt="game1" style="width: 100%;height: 66px;" align="center">
                        </button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100" style="border-radius: 30px;">
                        <img src="<?=base_url('./assets/img/client/AMEBA1.png');?>" alt="game1" style="width: 100%;height: 61px;" align="center">
                        </button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100" style="border-radius: 30px;">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100 p-0" style="border-radius: 30px;">
                        <img src="<?=base_url('./assets/img/client/slot-xo-logo-01.png');?>" alt="game1" style="width: 76px;height: 60px;" align="center">
                        </button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100 p-0" style="border-radius: 30px;">
                            <img src="<?=base_url('./assets/img/client/ambpoker_logo.426740ad.png');?>" alt="game1" style="width: 76px;height: 60px;" align="center">
                        </button>
                    </div>
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 mb-2">
                        <button type="button" class="btn btn-light w-100 p-0" style="border-radius: 30px;">
                        <img src="<?=base_url('./assets/img/client/ez-slot-logo-evo-play.png');?>" alt="game1" style="width: 100%;height: 51px;" align="center">
                        </button>
                    </div>
                </div>
            ...
            <div class="col-12 col-sm-12 col-md-9 col-lg-9 col-xl-9">
                <div class="row">
                    ...
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game6.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card2 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game1.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card3 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game2.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card4 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game3.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card5 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game4.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card6 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game5.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card7 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game7.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card8 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game12.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card9 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game11.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card10 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game10.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card11 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game9.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card12 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game8.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card13 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game13.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card14 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game18.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card15 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game17.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card16 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game16.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <!-- card17 -->
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game15.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
                    <div class="col-4 col-sm-4 col-md-2 col-lg-2 col-xl-2 p-2">
                        <div class="card mb-4 bg-transparent border-0" style="border-radius: 10px;">
                            <img class="card-img-top" src="<?=base_url('./assets/img/client/game14.png');?>" class="img-fluid" alt="Card image cap" style="border-radius: 10px;">
                        </div>
                    </div>
